...
public class EmailAuthService {
    ...
    public String sendEmail(String userEmail,String type) {
        ...
        String findIdMsg = "<html><body>"
                ...
                + authNumber
                + "</strong></div>"
                + "<br><p>위 인증코드를 아이디 찾기 페이지에 입력해주세요.</p>"
                + "</body></html>";
        ...
        String changePassword = "<html><body>"
                ...
                + authNumber
                + "</strong></div>"
                + "<br><p>위 인증코드를 비밀번호 변경 페이지에 입력해주세요.</p>"
                + "</body></html>";
        ...
        try {
            ...
            if(type.equals("find")){
                helper.setText(findIdMsg, true);  // HTML 이메일 (true는 HTML을 의미)
            } else if (type.equals("change")) {
                helper.setText(changePassword, true);  // HTML 이메일 (true는 HTML을 의미)
            } else{
            ...
            log.info("이메일 인증코드 -> userEmail:  " + userEmail + " 인증번호: " + authNumber);
            return "y";
